                ...
                <div className='container_reset__pass'>
                    ...
                    <form method='POST' className='reset__pass__info'>
                        ...
                        <div className='btns_submit'>
                            <input type='submit' name='confirm_email' className='confirm_email__btn' id='confirm_email__btn' onClick={verifyAndPostEmail} value='Confirm Email' disabled={isLoading} />
                        </div>
                    </form>
                </div>
            </div>
